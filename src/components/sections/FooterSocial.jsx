  ...
  return (
    <footer
      className={
        LightMode
          ? "black"
          : "bg-gradient-to-b from-secondary to-[#F2F2F2] full gap-y-[42px] text-black font-secondFont text-left text-paragraph4 flex flex-col justify-between items-center bg-cover bg-center bg-no-repeat"
      }
    >
